...
namespace lib {
	::avm::fault_injection::v0::point_t fault_injection_point_point_v0 __attribute__((used)) = { "lib", "point_v0", "Point version 0", 0, false, ::avm::fault_injection::mode_t::multiple };
...
{
	// Code manually
	if (FAULT_INJECTION_READ_V0(lib::fault_injection_point_point_v0.active)) {
		if (FAULT_INJECTION_READ_V0(lib::fault_injection_point_point_v0.mode) == ::avm::fault_injection::mode_t::multiple) {
			FAULT_INJECTION_WRITE_V0(lib::fault_injection_point_point_v0.active, false);
		}
